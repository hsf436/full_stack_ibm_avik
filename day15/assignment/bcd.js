document.addEventListener("DOMContentLoaded", function () {
    ...
    renderCart();
    const checkoutPageButton = document.createElement("button");
    checkoutPageButton.textContent = "Proceed to Checkout";
    checkoutPageButton.id = "checkoutPage";
    document.body.appendChild(checkoutPageButton);
    
    checkoutPageButton.addEventListener("click", function () {
